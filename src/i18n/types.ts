...
export interface Messages {
  ...
  agent: {
    ...
    propTypeApartments: string;
    propTypeVillas: string;
    propTypeStudios: string;
    propTypeLand: string;
    propTypeOffices: string;
    propTypeWarehouses: string;
    aboutSection: string;
  ...
  agency: {
    ...
    filterTeamSize: string;
    filterAllSizes: string;
    filterLanguage: string;
    filterAllLanguages: string;
    filterApply: string;
    filterReset: string;
    rentalFocusAll: string;
    rentalFocusLong: string;
    rentalFocusShort: string;
    rentalFocusBoth: string;
    minAgents2: string;
    minAgents5: string;
    minAgents10: string;
    propTypeApartments: string;
  ...
  espaceAgent: {
    ...
    boostBtn: string;
    boostBadge: string;
    boostModalTitle: string;
    boostStep1: string;
    boostStep2: string;
    boostStep3: string;
    boostPlanDays: string;
    boostRecommended: string;
    boostPayWith: string;
    boostPayOrangeMoney: string;
    boostPayMtnMoney: string;
    boostPayAirtelMoney: string;
    boostPayMpesa: string;
    boostPayCash: string;
    boostPayNumber: string;
    boostPayRef: string;
    boostPayRefCopied: string;
    boostScreenshotLabel: string;
    boostScreenshotBtn: string;
    boostScreenshotUploading: string;
    boostNextBtn: string;
    boostSubmitBtn: string;
    boostConfirmTitle: string;
    boostConfirmDesc: string;
    boostDoneBtn: string;
    boostTabPending: string;
    boostTabActive: string;
    boostTabHistory: string;
    boostStatusPending: string;
    boostStatusConfirmed: string;
    boostStatusRejected: string;
    boostStatusExpired: string;
    boostActiveUntil: string;
    boostRejectedReason: string;
    boostEmpty: string;
