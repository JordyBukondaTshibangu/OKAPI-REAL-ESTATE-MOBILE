...
export default function AgentAnnoncesScreen() {
  ...
  const { data: listingsData, isLoading: loading } = useQuery({
    queryKey: ["agent-annonces", agent?.id],
    queryFn: () => axios
      ...
      { text: t.cancelBtn, style: "cancel" },
      {
        ...
        onPress: async () => {
          ...
          try {
            ...
            // Invalidate all listing caches so dashboard + this list both refresh
            queryClient.invalidateQueries({ queryKey: ["agent-annonces"] });
